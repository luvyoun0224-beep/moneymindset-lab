...
for (const legalPage of ["privacy.html", "disclaimer.html", "contact.html", "about.html"]) {
  const page = scannedFiles.find((file) => file.relativePath === legalPage);
  if (page?.content.includes("ad-slot")) {
    monetizationFailures.push(`${legalPage}: legal/about pages should not contain ad slots.`);
  }
}
